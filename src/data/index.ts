...
export const RADIO_FIELDS = [
  {
    ...
    classes: 'mr-[2.25vw]',
    radioArray: [
      { name: 'Društvene mreže (Instagram / TikTok / Facebook)', value: 'Društvene mreže (Instagram / TikTok / Facebook)' },
      { name: 'Foto & video produkcija', value: 'Foto & video produkcija' },
      { name: 'Brendiranje i dizajn', value: 'Brendiranje i dizajn' },
      { name: 'Izrada web sajta', value: 'Izrada web sajta' },
  ...
  },
  {
    ...
    classes: '',
    radioArray: [
      { name: 'do 200 €', value: 'do 200 €' },
      { name: '200 € - 400 €', value: '200 € - 400 €' },
      { name: '400 € - 700 €', value: '400 € - 700 €' },
      { name: 'preko 700 €', value: 'preko 700 €' },
    ],
    formKey: '_budget',
  },
  {
    ...
    classes: 'mr-[2.25vw]',
    radioArray: [
      { name: 'Povećanje prodaje', value: 'Povećanje prodaje' },
      { name: 'Rast na društvenim mrežama', value: 'Rast na društvenim mrežama' },
      { name: 'Izgradnja brenda', value: 'Izgradnja brenda' },
      { name: 'Novi sajt / redizajn postojećeg', value: 'Novi sajt / redizajn postojećeg' },
  ...
  },
  {
    ...
    classes: '',
    radioArray: [
      { name: 'Što pre', value: 'Što pre' },
      { name: 'U narednih 7 dana', value: 'U narednih 7 dana ' },
      { name: 'Tokom sledećeg meseca', value: 'Tokom sledećeg meseca' },
      { name: 'Samo prikupljam informacije', value: 'Samo prikupljam informacije' },
    ],
    formKey: '_quickness',
  },
];
